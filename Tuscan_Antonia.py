...
class EvidencijaApp:
    ...
    def kreiraj_gui(self):
        # Unos okvir
        unos = tk.Frame(self.root, padx=10, pady=10, bg="lightgreen")
        unos.grid(row=0, column=0, sticky="EW")
        unos.columnconfigure(1, weight=1)


        tk.Label(unos, text="Ime:",bg="lightgreen").grid(row=0, column=0, sticky="W")
        self.e_ime = tk.Entry(unos); self.e_ime.grid(row=0, column=1, sticky="EW")

        tk.Label(unos, text="Prezime:",bg="lightgreen").grid(row=1, column=0, sticky="W")
        self.e_prezime = tk.Entry(unos); self.e_prezime.grid(row=1, column=1, sticky="EW")

        tk.Label(unos, text="Razred:",bg="lightgreen").grid(row=2, column=0, sticky="W")
